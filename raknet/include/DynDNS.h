...
public:
	...
	// Output
	bool IsRunning(void) const {return connectPhase!=RNCP_IDLE;}
	bool IsCompleted(void) const {return connectPhase==RNCP_IDLE;}
...
protected:
	...
	enum ConnectPhase
	{
		RNCP_CONNECTING_TO_CHECKIP,
		RNCP_WAITING_FOR_CHECKIP_RESPONSE,
		RNCP_CONNECTING_TO_DYNDNS,
		RNCP_WAITING_FOR_DYNDNS_RESPONSE,
		RNCP_IDLE
	};
